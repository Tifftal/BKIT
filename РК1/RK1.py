...
group = [
    Group(1, "RT5-31B", 1, 56.67),
    Group(2, "IU5-31B", 2, 31.42),
    Group(3, "RK6-41B", 3, 78.89),
    Group(4, "E9-21B", 4, 99.99),
    Group(5, "MT2-11B", 5, 3.14),
]
...
# Выведите список всех отделов, у которых в названии присутствует слово «Course»,
...
# в каждом отделе, отсортированный по средней зарплате
